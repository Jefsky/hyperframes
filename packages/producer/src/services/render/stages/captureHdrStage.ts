...
export async function runCaptureHdrStage(
  ...
  // captureAlphaPng hangs under --enable-begin-frame-control; force
  // screenshot mode for the whole layered path. Same constraint as the
  // alpha output formats elsewhere in the renderer.
